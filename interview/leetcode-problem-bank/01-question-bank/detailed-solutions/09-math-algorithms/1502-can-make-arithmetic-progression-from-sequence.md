...
- LeetCode 链接：https://leetcode.cn/problems/can-make-arithmetic-progression-from-sequence/
- 题目 slug：`can-make-arithmetic-progression-from-sequence`
- 来源专题：数学算法
- 来源分类路径：七、杂项 / §7.10 其他
- 难度分：Unknown
- 外部题解来源：https://leetcode.cn/problems/can-make-arithmetic-progression-from-sequence/solutions/3831655/liang-chong-fang-fa-cong-onlogn-dao-onpy-izlo/
...
- 题解标题：[两种方法：从 O(nlogn) 到 O(n)（Python/Java/C++/Go/JS/Rust）](https://leetcode.cn/problems/can-make-arithmetic-progression-from-sequence/solutions/3831655/liang-chong-fang-fa-cong-onlogn-dao-onpy-izlo/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`liang-chong-fang-fa-cong-onlogn-dao-onpy-izlo`
- topic id：`3831655`
