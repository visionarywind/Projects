...
- LeetCode 链接：https://leetcode.cn/problems/check-if-the-rectangle-corner-is-reachable/
- 题目 slug：`check-if-the-rectangle-corner-is-reachable`
- 来源专题：数学算法
- 来源分类路径：五、计算几何 / §5.2 圆
- 难度分：Unknown
- 外部题解来源：https://leetcode.cn/problems/check-if-the-rectangle-corner-is-reachable/solutions/2860214/deng-jie-zhuan-huan-bing-cha-ji-pythonja-yf9y/
...
- 题解标题：[【图解】转换成图上 DFS + 避免浮点数的做法（Python/Java/C++/C/Go/JS/Rust）](https://leetcode.cn/problems/check-if-the-rectangle-corner-is-reachable/solutions/2860214/deng-jie-zhuan-huan-bing-cha-ji-pythonja-yf9y/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`deng-jie-zhuan-huan-bing-cha-ji-pythonja-yf9y`
- topic id：`2860214`
...
本题来自 `五、计算几何 / §5.2 圆`。先把题目抽象为该分类下的标准模型：确定要维护的对象、合法状态和答案更新时机，再用来源题解正文校准细节。
...
回到来源分类 `五、计算几何 / §5.2 圆`，选择同小节后续题目训练。若新题只是维护量变化，优先复用当前框架；若合法性条件变化，再调整枚举顺序、收缩策略或状态转移。
