...
- LeetCode 链接：https://leetcode.cn/problems/angles-of-a-triangle/
- 题目 slug：`angles-of-a-triangle`
- 来源专题：数学算法
- 来源分类路径：五、计算几何 / §5.5 其他
- 难度分：1407
- 外部题解来源：https://leetcode.cn/problems/angles-of-a-triangle/solutions/3949898/yu-xian-ding-li-pythonjavacgo-by-endless-zwhx/
...
- 题解标题：[余弦定理（Python/Java/C++/Go）](https://leetcode.cn/problems/angles-of-a-triangle/solutions/3949898/yu-xian-ding-li-pythonjavacgo-by-endless-zwhx/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`yu-xian-ding-li-pythonjavacgo-by-endless-zwhx`
- topic id：`3949898`
...
本题来自 `五、计算几何 / §5.5 其他`。先把题目抽象为该分类下的标准模型：确定要维护的对象、合法状态和答案更新时机，再用来源题解正文校准细节。
...
回到来源分类 `五、计算几何 / §5.5 其他`，选择同小节后续题目训练。若新题只是维护量变化，优先复用当前框架；若合法性条件变化，再调整枚举顺序、收缩策略或状态转移。
