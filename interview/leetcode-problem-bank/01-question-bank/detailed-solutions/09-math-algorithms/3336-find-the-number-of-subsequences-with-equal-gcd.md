...
- LeetCode 链接：https://leetcode.cn/problems/find-the-number-of-subsequences-with-equal-gcd/
- 题目 slug：`find-the-number-of-subsequences-with-equal-gcd`
- 来源专题：数学算法
- 来源分类路径：一、数论 / §1.11 莫比乌斯函数
- 难度分：Unknown
- 外部题解来源：https://leetcode.cn/problems/find-the-number-of-subsequences-with-equal-gcd/solutions/2967084/duo-wei-dppythonjavacgo-by-endlesscheng-5pk3/
...
- 题解标题：[两种方法：多维 DP / 倍数容斥（Python/Java/C++/Go）](https://leetcode.cn/problems/find-the-number-of-subsequences-with-equal-gcd/solutions/2967084/duo-wei-dppythonjavacgo-by-endlesscheng-5pk3/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`duo-wei-dppythonjavacgo-by-endlesscheng-5pk3`
- topic id：`2967084`
...
本题来自 `一、数论 / §1.11 莫比乌斯函数`。先把题目抽象为该分类下的标准模型：确定要维护的对象、合法状态和答案更新时机，再用来源题解正文校准细节。
...
回到来源分类 `一、数论 / §1.11 莫比乌斯函数`，选择同小节后续题目训练。若新题只是维护量变化，优先复用当前框架；若合法性条件变化，再调整枚举顺序、收缩策略或状态转移。
