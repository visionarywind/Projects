...
- LeetCode 链接：https://leetcode.cn/problems/count-substrings-that-satisfy-k-constraint-i/
- 题目 slug：`count-substrings-that-satisfy-k-constraint-i`
- 来源专题：滑动窗口与双指针
- 来源分类路径：二、不定长滑动窗口 / §2.3 求子数组个数 / §2.3.1 越短越合法
- 难度分：Unknown
- 外部题解来源：https://leetcode.cn/problems/count-substrings-that-satisfy-k-constraint-i/solutions/2884495/on-hua-dong-chuang-kou-pythonjavacgo-by-keubv/
...
- 题解标题：[「越短越合法」型滑动窗口（Python/Java/C++/Go）](https://leetcode.cn/problems/count-substrings-that-satisfy-k-constraint-i/solutions/2884495/on-hua-dong-chuang-kou-pythonjavacgo-by-keubv/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`on-hua-dong-chuang-kou-pythonjavacgo-by-keubv`
- topic id：`2884495`
