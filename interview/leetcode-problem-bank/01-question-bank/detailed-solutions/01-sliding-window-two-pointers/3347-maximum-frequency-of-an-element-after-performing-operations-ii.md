...
- LeetCode 链接：https://leetcode.cn/problems/maximum-frequency-of-an-element-after-performing-operations-ii/
- 题目 slug：`maximum-frequency-of-an-element-after-performing-operations-ii`
- 来源专题：滑动窗口与双指针
- 来源分类路径：五、三指针
- 难度分：2156
- 外部题解来源：https://leetcode.cn/problems/maximum-frequency-of-an-element-after-performing-operations-ii/solutions/2983355/liang-chong-fang-fa-chai-fen-hua-dong-ch-7buy/
...
- 题解标题：[两种方法：差分/三指针+双指针（Python/Java/C++/Go）](https://leetcode.cn/problems/maximum-frequency-of-an-element-after-performing-operations-ii/solutions/2983355/liang-chong-fang-fa-chai-fen-hua-dong-ch-7buy/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`liang-chong-fang-fa-chai-fen-hua-dong-ch-7buy`
- topic id：`2983355`
...
本题来自 `五、三指针`。先把题目抽象为该分类下的标准模型：确定要维护的对象、合法状态和答案更新时机，再用来源题解正文校准细节。
...
回到来源分类 `五、三指针`，选择同小节后续题目训练。若新题只是维护量变化，优先复用当前框架；若合法性条件变化，再调整枚举顺序、收缩策略或状态转移。
