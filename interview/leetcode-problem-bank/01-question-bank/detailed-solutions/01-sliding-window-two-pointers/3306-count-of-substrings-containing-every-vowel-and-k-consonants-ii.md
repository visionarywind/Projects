...
- LeetCode 链接：https://leetcode.cn/problems/count-of-substrings-containing-every-vowel-and-k-consonants-ii/
- 题目 slug：`count-of-substrings-containing-every-vowel-and-k-consonants-ii`
- 来源专题：滑动窗口与双指针
- 来源分类路径：二、不定长滑动窗口 / §2.3 求子数组个数 / §2.3.3 恰好型滑动窗口
- 难度分：2200
- 外部题解来源：https://leetcode.cn/problems/count-of-substrings-containing-every-vowel-and-k-consonants-ii/solutions/2934309/liang-ci-hua-chuang-pythonjavacgo-by-end-2lpz/
...
- 题解标题：[恰好型滑动窗口：转换成两个至少型滑动窗口（Python/Java/C++/Go）](https://leetcode.cn/problems/count-of-substrings-containing-every-vowel-and-k-consonants-ii/solutions/2934309/liang-ci-hua-chuang-pythonjavacgo-by-end-2lpz/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`liang-ci-hua-chuang-pythonjavacgo-by-end-2lpz`
- topic id：`2934309`
...
本题来自 `二、不定长滑动窗口 / §2.3 求子数组个数 / §2.3.3 恰好型滑动窗口`。先把题目抽象为该分类下的标准模型：确定要维护的对象、合法状态和答案更新时机，再用来源题解正文校准细节。
...
回到来源分类 `二、不定长滑动窗口 / §2.3 求子数组个数 / §2.3.3 恰好型滑动窗口`，选择同小节后续题目训练。若新题只是维护量变化，优先复用当前框架；若合法性条件变化，再调整枚举顺序、收缩策略或状态转移。
