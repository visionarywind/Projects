...
- 题目 slug：`count-pairs-whose-sum-is-less-than-target`
- 来源专题：滑动窗口与双指针
- 来源分类路径：三、单序列双指针 / §3.2 相向双指针
- 难度分：Unknown
- 外部题解来源：https://leetcode.cn/problems/count-pairs-whose-sum-is-less-than-target/solutions/2396216/onlogn-pai-xu-shuang-zhi-zhen-by-endless-qk40/
...
- 题解标题：[O(nlogn) 排序+相向双指针（Python/Java/C++/C/Go/JS/Rust）](https://leetcode.cn/problems/count-pairs-whose-sum-is-less-than-target/solutions/2396216/onlogn-pai-xu-shuang-zhi-zhen-by-endless-qk40/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`onlogn-pai-xu-shuang-zhi-zhen-by-endless-qk40`
- topic id：`2396216`
