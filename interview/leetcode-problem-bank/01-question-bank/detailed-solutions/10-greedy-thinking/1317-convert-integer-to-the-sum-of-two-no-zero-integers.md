...
- LeetCode 链接：https://leetcode.cn/problems/convert-integer-to-the-sum-of-two-no-zero-integers/
- 题目 slug：`convert-integer-to-the-sum-of-two-no-zero-integers`
- 来源专题：贪心与思维
- 来源分类路径：六、构造题
- 难度分：Unknown
- 外部题解来源：https://leetcode.cn/problems/convert-integer-to-the-sum-of-two-no-zero-integers/solutions/3761217/san-chong-fang-fa-mei-ju-sui-ji-gou-zao-fown3/
...
- 题解标题：[三种方法：枚举/随机/构造（Python/Java/C++/C/Go/JS/Rust）](https://leetcode.cn/problems/convert-integer-to-the-sum-of-two-no-zero-integers/solutions/3761217/san-chong-fang-fa-mei-ju-sui-ji-gou-zao-fown3/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`san-chong-fang-fa-mei-ju-sui-ji-gou-zao-fown3`
- topic id：`3761217`
...
public:
    vector<int> getNoZeroIntegers(int n) {
        for (int a = 1; ; a++) {
            if (!to_string(a).contains('0') && !to_string(n - a).contains('0')) {
                return {a, n - a};
            }
        }
    }
