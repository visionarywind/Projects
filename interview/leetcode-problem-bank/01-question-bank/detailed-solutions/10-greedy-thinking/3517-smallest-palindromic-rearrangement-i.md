...
- LeetCode 链接：https://leetcode.cn/problems/smallest-palindromic-rearrangement-i/
- 题目 slug：`smallest-palindromic-rearrangement-i`
- 来源专题：贪心与思维
- 来源分类路径：三、字符串贪心 / §3.1 字典序最小/最大
- 难度分：1357
- 外部题解来源：https://leetcode.cn/problems/smallest-palindromic-rearrangement-i/solutions/3649564/pai-xu-zuo-ban-bu-fen-pythonjavacgo-by-e-5e5a/
...
- 题解标题：[排序左半部分 + 计数排序优化（Python/Java/C++/Go）](https://leetcode.cn/problems/smallest-palindromic-rearrangement-i/solutions/3649564/pai-xu-zuo-ban-bu-fen-pythonjavacgo-by-e-5e5a/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`pai-xu-zuo-ban-bu-fen-pythonjavacgo-by-e-5e5a`
- topic id：`3649564`
...
- 空间复杂度：$\mathcal{O}(n)$ 或 $\mathcal{O}(1)$，取决于能否直接修改字符串。
