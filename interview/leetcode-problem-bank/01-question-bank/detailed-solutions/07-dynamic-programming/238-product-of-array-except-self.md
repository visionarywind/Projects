...
- 题目 slug：`product-of-array-except-self`
- 来源专题：动态规划
- 来源分类路径：专题：前后缀分解
- 难度分：Unknown
- 外部题解来源：https://leetcode.cn/problems/product-of-array-except-self/solutions/2783788/qian-hou-zhui-fen-jie-fu-ti-dan-pythonja-86r1/
...
- 题解标题：[前后缀分解，附题单！（Python/Java/C++/C/Go/JS/Rust）](https://leetcode.cn/problems/product-of-array-except-self/solutions/2783788/qian-hou-zhui-fen-jie-fu-ti-dan-pythonja-86r1/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`qian-hou-zhui-fen-jie-fu-ti-dan-pythonja-86r1`
- topic id：`2783788`
...
初始值：$\textit{pre}[0] = \textit{suf}[n-1] = 1$。按照上文的定义，$\textit{pre}[0]$ 和 $\textit{suf}[n-1]$ 都是**空子数组**的元素乘积，我们规定这是 $1$，因为 $1$ 乘以任何数 $x$ 都等于 $x$，这样可以方便递推计算 $\textit{pre}[1]$，$\textit{suf}[n-2]$ 等。
