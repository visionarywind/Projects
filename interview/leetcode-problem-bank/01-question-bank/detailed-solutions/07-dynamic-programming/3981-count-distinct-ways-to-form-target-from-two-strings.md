...
- LeetCode 链接：https://leetcode.cn/problems/count-distinct-ways-to-form-target-from-two-strings/
- 题目 slug：`count-distinct-ways-to-form-target-from-two-strings`
- 来源专题：动态规划
- 来源分类路径：四、经典线性 DP / §4.2 最长递增子序列（LIS） / §4.2.2 进阶
- 难度分：2128
- 外部题解来源：https://leetcode.cn/problems/count-distinct-ways-to-form-target-from-two-strings/solutions/3991793/dong-tai-gui-hua-rong-chi-by-endlesschen-wryr/
...
- 题解标题：[动态规划 + 容斥（Python/Java/C++/Go）](https://leetcode.cn/problems/count-distinct-ways-to-form-target-from-two-strings/solutions/3991793/dong-tai-gui-hua-rong-chi-by-endlesschen-wryr/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`dong-tai-gui-hua-rong-chi-by-endlesschen-wryr`
- topic id：`3991793`
