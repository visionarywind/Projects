...
- LeetCode 链接：https://leetcode.cn/problems/smallest-divisible-digit-product-ii/
- 题目 slug：`smallest-divisible-digit-product-ii`
- 来源专题：动态规划
- 来源分类路径：十、数位 DP / §10.3 其他数位 DP
- 难度分：3101
- 外部题解来源：https://leetcode.cn/problems/smallest-divisible-digit-product-ii/solutions/2984014/bao-sou-zuo-fa-lei-si-shu-wei-dp-by-endl-nkoo/
...
- 题解标题：[两种方法：从左到右暴搜/从右到左枚举（Python/Java/C++/Go）](https://leetcode.cn/problems/smallest-divisible-digit-product-ii/solutions/2984014/bao-sou-zuo-fa-lei-si-shu-wei-dp-by-endl-nkoo/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`bao-sou-zuo-fa-lei-si-shu-wei-dp-by-endl-nkoo`
- topic id：`2984014`
...
本题来自 `十、数位 DP / §10.3 其他数位 DP`。先把题目抽象为该分类下的标准模型：确定要维护的对象、合法状态和答案更新时机，再用来源题解正文校准细节。
...
回到来源分类 `十、数位 DP / §10.3 其他数位 DP`，选择同小节后续题目训练。若新题只是维护量变化，优先复用当前框架；若合法性条件变化，再调整枚举顺序、收缩策略或状态转移。
