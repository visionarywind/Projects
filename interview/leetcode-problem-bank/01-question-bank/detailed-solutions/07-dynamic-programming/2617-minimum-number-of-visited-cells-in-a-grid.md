...
- LeetCode 链接：https://leetcode.cn/problems/minimum-number-of-visited-cells-in-a-grid/
- 题目 slug：`minimum-number-of-visited-cells-in-a-grid`
- 来源专题：动态规划
- 来源分类路径：十一、优化 DP / §11.2 单调栈优化 DP
- 难度分：2582
- 外部题解来源：https://leetcode.cn/problems/minimum-number-of-visited-cells-in-a-grid/solutions/2216329/dan-diao-zhan-you-hua-dp-by-endlesscheng-mc50/
...
- 题解标题：[两种方法：单调栈优化 DP / 贪心+最小堆（Python/Java/C++/Go/JS/Rust）](https://leetcode.cn/problems/minimum-number-of-visited-cells-in-a-grid/solutions/2216329/dan-diao-zhan-you-hua-dp-by-endlesscheng-mc50/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`dan-diao-zhan-you-hua-dp-by-endlesscheng-mc50`
- topic id：`2216329`
...
本题来自 `十一、优化 DP / §11.2 单调栈优化 DP`。先把题目抽象为该分类下的标准模型：确定要维护的对象、合法状态和答案更新时机，再用来源题解正文校准细节。
...
回到来源分类 `十一、优化 DP / §11.2 单调栈优化 DP`，选择同小节后续题目训练。若新题只是维护量变化，优先复用当前框架；若合法性条件变化，再调整枚举顺序、收缩策略或状态转移。
