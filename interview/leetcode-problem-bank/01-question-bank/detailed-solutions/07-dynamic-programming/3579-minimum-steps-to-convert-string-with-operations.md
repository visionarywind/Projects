...
- LeetCode 链接：https://leetcode.cn/problems/minimum-steps-to-convert-string-with-operations/
- 题目 slug：`minimum-steps-to-convert-string-with-operations`
- 来源专题：动态规划
- 来源分类路径：五、划分型 DP / §5.2 最优划分
- 难度分：2493
- 外部题解来源：https://leetcode.cn/problems/minimum-steps-to-convert-string-with-operations/solutions/3695734/hua-fen-xing-dp-tan-xin-pythonjavacgo-by-17kb/
...
- 题解标题：[O(n^2) 做法：划分型 DP + 贪心 + 中心扩展法（Python/Java/C++/Go）](https://leetcode.cn/problems/minimum-steps-to-convert-string-with-operations/solutions/3695734/hua-fen-xing-dp-tan-xin-pythonjavacgo-by-17kb/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`hua-fen-xing-dp-tan-xin-pythonjavacgo-by-17kb`
- topic id：`3695734`
