...
- LeetCode 链接：https://leetcode.cn/problems/minimum-number-of-valid-strings-to-form-target-ii/
- 题目 slug：`minimum-number-of-valid-strings-to-form-target-ii`
- 来源专题：动态规划
- 来源分类路径：十一、优化 DP / §11.9 其他优化 DP
- 难度分：Unknown
- 外部题解来源：https://leetcode.cn/problems/minimum-number-of-valid-strings-to-form-target-ii/solutions/2917929/ac-zi-dong-ji-pythonjavacgo-by-endlessch-hcqk/
...
- 题解标题：[三种方法：Z 函数 / 字符串哈希 / AC 自动机（Python/Java/C++/Go）](https://leetcode.cn/problems/minimum-number-of-valid-strings-to-form-target-ii/solutions/2917929/ac-zi-dong-ji-pythonjavacgo-by-endlessch-hcqk/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`ac-zi-dong-ji-pythonjavacgo-by-endlessch-hcqk`
- topic id：`2917929`
...
本题来自 `十一、优化 DP / §11.9 其他优化 DP`。先把题目抽象为该分类下的标准模型：确定要维护的对象、合法状态和答案更新时机，再用来源题解正文校准细节。
...
回到来源分类 `十一、优化 DP / §11.9 其他优化 DP`，选择同小节后续题目训练。若新题只是维护量变化，优先复用当前框架；若合法性条件变化，再调整枚举顺序、收缩策略或状态转移。
