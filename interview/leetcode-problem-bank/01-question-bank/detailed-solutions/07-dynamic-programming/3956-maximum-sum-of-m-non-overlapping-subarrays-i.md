...
- LeetCode 链接：https://leetcode.cn/problems/maximum-sum-of-m-non-overlapping-subarrays-i/
- 题目 slug：`maximum-sum-of-m-non-overlapping-subarrays-i`
- 来源专题：动态规划
- 来源分类路径：十一、优化 DP / §11.3 单调队列优化 DP
- 难度分：2061
- 外部题解来源：https://leetcode.cn/problems/maximum-sum-of-m-non-overlapping-subarrays-i/solutions/3980513/dan-diao-dui-lie-you-hua-dppythonjavacgo-lpex/
...
- 题解标题：[单调队列优化 DP（Python/Java/C++/Go）](https://leetcode.cn/problems/maximum-sum-of-m-non-overlapping-subarrays-i/solutions/3980513/dan-diao-dui-lie-you-hua-dppythonjavacgo-lpex/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`dan-diao-dui-lie-you-hua-dppythonjavacgo-lpex`
- topic id：`3980513`
...
**注**：利用下一题的结论，对于本题的做法，可以在 $f[i][n]\le \textit{ans}$ 时，提前返回答案。读者可以试一试~
