...
- LeetCode 链接：https://leetcode.cn/problems/maximum-alternating-subsequence-sum/
- 题目 slug：`maximum-alternating-subsequence-sum`
- 来源专题：动态规划
- 来源分类路径：六、状态机 DP / §6.2 基础
- 难度分：1786
- 外部题解来源：https://leetcode.cn/problems/maximum-alternating-subsequence-sum/solutions/846375/dong-tai-gui-hua-by-endlesscheng-d92a/
...
- 题解标题：[动态规划](https://leetcode.cn/problems/maximum-alternating-subsequence-sum/solutions/846375/dong-tai-gui-hua-by-endlesscheng-d92a/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`dong-tai-gui-hua-by-endlesscheng-d92a`
- topic id：`846375`
...
func maxAlternatingSum(nums []int) int64 {
	f := [2]int{0, math.MinInt / 2} // 除 2 防止计算时溢出
	for _, v := range nums {
