...
- 题目 slug：`shortest-common-supersequence`
- 来源专题：动态规划
- 来源分类路径：四、经典线性 DP / §4.1 最长公共子序列（LCS） / §4.1.2 进阶
- 难度分：Unknown
- 外部题解来源：https://leetcode.cn/problems/shortest-common-supersequence/solutions/2194615/cong-di-gui-dao-di-tui-jiao-ni-yi-bu-bu-auy8z/
...
- 题解标题：[从递归到递推，教你一步步思考动态规划！（Python/Java/C++/Go）](https://leetcode.cn/problems/shortest-common-supersequence/solutions/2194615/cong-di-gui-dao-di-tui-jiao-ni-yi-bu-bu-auy8z/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`cong-di-gui-dao-di-tui-jiao-ni-yi-bu-bu-auy8z`
- topic id：`2194615`
...
class Solution {
    ...
    // makeAns(i,j) 返回 s 的前缀 [0,i] 和 t 的前缀 [0,j] 的最短公共超序列
    // 看上去和 dfs 没啥区别，但是末尾的递归是 if-else
