...
- LeetCode 链接：https://leetcode.cn/problems/maximum-sum-of-m-non-overlapping-subarrays-ii/
- 题目 slug：`maximum-sum-of-m-non-overlapping-subarrays-ii`
- 来源专题：动态规划
- 来源分类路径：十一、优化 DP / §11.8 WQS 二分优化 DP
- 难度分：2611
- 外部题解来源：https://leetcode.cn/problems/maximum-sum-of-m-non-overlapping-subarrays-ii/solutions/3980778/la-ge-lang-ri-song-chi-wqs-er-fen-python-m2iw/
...
- 题解标题：[拉格朗日松弛（WQS 二分）Python/Java/C++/Go](https://leetcode.cn/problems/maximum-sum-of-m-non-overlapping-subarrays-ii/solutions/3980778/la-ge-lang-ri-song-chi-wqs-er-fen-python-m2iw/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`la-ge-lang-ri-song-chi-wqs-er-fen-python-m2iw`
- topic id：`3980778`
...
本题来自 `十一、优化 DP / §11.8 WQS 二分优化 DP`。先把题目抽象为该分类下的标准模型：确定要维护的对象、合法状态和答案更新时机，再用来源题解正文校准细节。
...
回到来源分类 `十一、优化 DP / §11.8 WQS 二分优化 DP`，选择同小节后续题目训练。若新题只是维护量变化，优先复用当前框架；若合法性条件变化，再调整枚举顺序、收缩策略或状态转移。
