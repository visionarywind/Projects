...
- 题目 slug：`partition-equal-subset-sum`
- 来源专题：动态规划
- 来源分类路径：三、背包 / §3.1 0-1 背包
- 难度分：Unknown
- 外部题解来源：https://leetcode.cn/problems/partition-equal-subset-sum/solutions/2785266/0-1-bei-bao-cong-ji-yi-hua-sou-suo-dao-d-ev76/
...
- 题解标题：[三种写法：记忆化搜索 / 递推 / bitset 优化（Python/Java/C++/C/Go/JS/Rust）](https://leetcode.cn/problems/partition-equal-subset-sum/solutions/2785266/0-1-bei-bao-cong-ji-yi-hua-sou-suo-dao-d-ev76/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`0-1-bei-bao-cong-ji-yi-hua-sou-suo-dao-d-ev76`
- topic id：`2785266`
