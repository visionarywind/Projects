...
- 题目 slug：`add-two-numbers-ii`
- 来源专题：链表、树与回溯
- 来源分类路径：一、链表 / §1.8 合并链表
- 难度分：Unknown
- 外部题解来源：https://leetcode.cn/problems/add-two-numbers-ii/solutions/2328330/fan-zhuan-lian-biao-liang-shu-xiang-jia-okw6q/
...
- 题解标题：[反转链表+两数相加=秒杀！（Python/Java/C++/Go/JS）](https://leetcode.cn/problems/add-two-numbers-ii/solutions/2328330/fan-zhuan-lian-biao-liang-shu-xiang-jia-okw6q/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`fan-zhuan-lian-biao-liang-shu-xiang-jia-okw6q`
- topic id：`2328330`
...
同方法一，区别在于 $\texttt{reverseList}$ 和 $\texttt{addTwo}$ 都是迭代写法。
