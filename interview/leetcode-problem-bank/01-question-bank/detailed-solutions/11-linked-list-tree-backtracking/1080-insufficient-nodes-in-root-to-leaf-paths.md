...
- 题目 slug：`insufficient-nodes-in-root-to-leaf-paths`
- 来源专题：链表、树与回溯
- 来源分类路径：二、二叉树 / §2.5 有递有归
- 难度分：1805
- 外部题解来源：https://leetcode.cn/problems/insufficient-nodes-in-root-to-leaf-paths/solutions/2278769/jian-ji-xie-fa-diao-yong-zi-shen-pythonj-64lf/
...
- 题解标题：[简洁写法，调用自身！（Python/Java/C++/Go）](https://leetcode.cn/problems/insufficient-nodes-in-root-to-leaf-paths/solutions/2278769/jian-ji-xie-fa-diao-yong-zi-shen-pythonj-64lf/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`jian-ji-xie-fa-diao-yong-zi-shen-pythonj-64lf`
- topic id：`2278769`
