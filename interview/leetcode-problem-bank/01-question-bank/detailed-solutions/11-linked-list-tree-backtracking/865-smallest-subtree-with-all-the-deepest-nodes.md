...
- LeetCode 链接：https://leetcode.cn/problems/smallest-subtree-with-all-the-deepest-nodes/
- 题目 slug：`smallest-subtree-with-all-the-deepest-nodes`
- 来源专题：链表、树与回溯
- 来源分类路径：二、二叉树 / §2.5 有递有归
- 难度分：1534
- 外部题解来源：https://leetcode.cn/problems/smallest-subtree-with-all-the-deepest-nodes/solutions/2428730/liang-chong-on-di-gui-xie-fa-pythonjavac-hac3/
...
- 题解标题：[一次 DFS，两种写法（Python/Java/C++/C/Go/JS/Rust）](https://leetcode.cn/problems/smallest-subtree-with-all-the-deepest-nodes/solutions/2428730/liang-chong-on-di-gui-xie-fa-pythonjavac-hac3/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`liang-chong-on-di-gui-xie-fa-pythonjavac-hac3`
- topic id：`2428730`
- 授权状态：authorized-by-user-confirmation
- 导入时间：2026-09-17 11:39:45 +0800

**前置题目**：[236. 二叉树的最近公共祖先](https://leetcode.cn/problems/lowest-common-ancestor-of-a-binary-tree/)。

**视频讲解**：[二叉树的最近公共祖先【基础算法精讲 12】](https://www.bilibili.com/video/BV1W44y1Z7AR/)。

## 方法一：递归递归，有递有归

![](https://pic.leetcode.cn/1693882910-FIoXPj-sketch1.png){:width=360px}

看上图（示例 1），这棵树的节点 $3,5,2$ 都是最深叶节点 $7,4$ 的**公共祖先**，但只有节点 $2$ 是**最近**的公共祖先。
...
不一定。比如节点 $1$ 的左右子树最深叶节点 $0,8$ 的深度都是 $2$，但该深度并不是**全局最大深度**，所以节点 $1$ 并不能是答案。
