...
- LeetCode 链接：https://leetcode.cn/problems/minimum-operations-to-equalize-subarrays/
- 题目 slug：`minimum-operations-to-equalize-subarrays`
- 来源专题：常用数据结构
- 来源分类路径：八、树状数组和线段树 / §8.6 可持久化线段树
- 难度分：2497
- 外部题解来源：https://leetcode.cn/problems/minimum-operations-to-equalize-subarrays/solutions/3845357/zhong-wei-shu-tan-xin-ke-chi-jiu-hua-xia-etpv/
...
- 题解标题：[中位数贪心 + 可持久化线段树（Python/Java/C++/Go）](https://leetcode.cn/problems/minimum-operations-to-equalize-subarrays/solutions/3845357/zhong-wei-shu-tan-xin-ke-chi-jiu-hua-xia-etpv/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`zhong-wei-shu-tan-xin-ke-chi-jiu-hua-xia-etpv`
- topic id：`3845357`
...
本题来自 `八、树状数组和线段树 / §8.6 可持久化线段树`。先把题目抽象为该分类下的标准模型：确定要维护的对象、合法状态和答案更新时机，再用来源题解正文校准细节。
...
回到来源分类 `八、树状数组和线段树 / §8.6 可持久化线段树`，选择同小节后续题目训练。若新题只是维护量变化，优先复用当前框架；若合法性条件变化，再调整枚举顺序、收缩策略或状态转移。
