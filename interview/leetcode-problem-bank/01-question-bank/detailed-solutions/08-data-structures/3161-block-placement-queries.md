...
- LeetCode 链接：https://leetcode.cn/problems/block-placement-queries/
- 题目 slug：`block-placement-queries`
- 来源专题：常用数据结构
- 来源分类路径：八、树状数组和线段树 / §8.3 线段树（无区间更新）
- 难度分：2513
- 外部题解来源：https://leetcode.cn/problems/block-placement-queries/solutions/2790395/ping-heng-shu-xian-duan-shu-pythonjavacg-8klz/
...
- 题解标题：[三种方法：线段树/树状数组/并查集（Python/Java/C++/Go）](https://leetcode.cn/problems/block-placement-queries/solutions/2790395/ping-heng-shu-xian-duan-shu-pythonjavacg-8klz/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`ping-heng-shu-xian-duan-shu-pythonjavacg-8klz`
- topic id：`2790395`
