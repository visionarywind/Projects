...
- LeetCode 链接：https://leetcode.cn/problems/minimum-edge-weight-equilibrium-queries-in-a-tree/
- 题目 slug：`minimum-edge-weight-equilibrium-queries-in-a-tree`
- 来源专题：常用数据结构
- 来源分类路径：十、根号算法 / §10.2 莫队算法
- 难度分：Unknown
- 外部题解来源：https://leetcode.cn/problems/minimum-edge-weight-equilibrium-queries-in-a-tree/solutions/2424060/lca-mo-ban-by-endlesscheng-j54b/
...
- 题解标题：[LCA 模板（Python/Java/C++/Go）](https://leetcode.cn/problems/minimum-edge-weight-equilibrium-queries-in-a-tree/solutions/2424060/lca-mo-ban-by-endlesscheng-j54b/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`lca-mo-ban-by-endlesscheng-j54b`
- topic id：`2424060`
...
本题来自 `十、根号算法 / §10.2 莫队算法`。先把题目抽象为该分类下的标准模型：确定要维护的对象、合法状态和答案更新时机，再用来源题解正文校准细节。
...
回到来源分类 `十、根号算法 / §10.2 莫队算法`，选择同小节后续题目训练。若新题只是维护量变化，优先复用当前框架；若合法性条件变化，再调整枚举顺序、收缩策略或状态转移。
