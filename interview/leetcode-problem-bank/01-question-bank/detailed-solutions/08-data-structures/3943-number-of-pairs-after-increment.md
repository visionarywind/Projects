...
- LeetCode 链接：https://leetcode.cn/problems/number-of-pairs-after-increment/
- 题目 slug：`number-of-pairs-after-increment`
- 来源专题：常用数据结构
- 来源分类路径：十、根号算法 / §10.1 分块
- 难度分：2410
- 外部题解来源：https://leetcode.cn/problems/number-of-pairs-after-increment/solutions/3973347/fen-kuai-pythonjavacgo-by-endlesscheng-2fr9/
...
- 题解标题：[分块（Python/Java/C++/Go）](https://leetcode.cn/problems/number-of-pairs-after-increment/solutions/3973347/fen-kuai-pythonjavacgo-by-endlesscheng-2fr9/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`fen-kuai-pythonjavacgo-by-endlesscheng-2fr9`
- topic id：`3973347`
...
本题来自 `十、根号算法 / §10.1 分块`。先把题目抽象为该分类下的标准模型：确定要维护的对象、合法状态和答案更新时机，再用来源题解正文校准细节。
...
回到来源分类 `十、根号算法 / §10.1 分块`，选择同小节后续题目训练。若新题只是维护量变化，优先复用当前框架；若合法性条件变化，再调整枚举顺序、收缩策略或状态转移。
