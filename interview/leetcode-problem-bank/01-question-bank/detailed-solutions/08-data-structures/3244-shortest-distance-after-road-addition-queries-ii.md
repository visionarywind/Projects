...
- LeetCode 链接：https://leetcode.cn/problems/shortest-distance-after-road-addition-queries-ii/
- 题目 slug：`shortest-distance-after-road-addition-queries-ii`
- 来源专题：常用数据结构
- 来源分类路径：七、并查集 / §7.5 区间并查集
- 难度分：2270
- 外部题解来源：https://leetcode.cn/problems/shortest-distance-after-road-addition-queries-ii/solutions/2868558/qu-jian-bing-cha-ji-pythonjavacgo-by-end-a9k7/
...
- 题解标题：[两种方法：区间并查集 / 维护跳转位置（Python/Java/C++/Go）](https://leetcode.cn/problems/shortest-distance-after-road-addition-queries-ii/solutions/2868558/qu-jian-bing-cha-ji-pythonjavacgo-by-end-a9k7/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`qu-jian-bing-cha-ji-pythonjavacgo-by-end-a9k7`
- topic id：`2868558`
...
本题来自 `七、并查集 / §7.5 区间并查集`。先把题目抽象为该分类下的标准模型：确定要维护的对象、合法状态和答案更新时机，再用来源题解正文校准细节。
...
回到来源分类 `七、并查集 / §7.5 区间并查集`，选择同小节后续题目训练。若新题只是维护量变化，优先复用当前框架；若合法性条件变化，再调整枚举顺序、收缩策略或状态转移。
