...
- LeetCode 链接：https://leetcode.cn/problems/sum-of-variable-length-subarrays/
- 题目 slug：`sum-of-variable-length-subarrays`
- 来源专题：常用数据结构
- 来源分类路径：一、前缀和 / §1.1 基础
- 难度分：Unknown
- 外部题解来源：https://leetcode.cn/problems/sum-of-variable-length-subarrays/solutions/3051553/liang-chong-fang-fa-bao-li-chai-fen-shu-iuwyi/
...
- 题解标题：[三种方法：暴力 / 前缀和 / 差分数组（Python/Java/C++/Go）](https://leetcode.cn/problems/sum-of-variable-length-subarrays/solutions/3051553/liang-chong-fang-fa-bao-li-chai-fen-shu-iuwyi/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`liang-chong-fang-fa-bao-li-chai-fen-shu-iuwyi`
- topic id：`3051553`
