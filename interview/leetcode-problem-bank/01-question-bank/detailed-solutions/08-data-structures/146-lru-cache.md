...
- 题目 slug：`lru-cache`
- 来源专题：常用数据结构
- 来源分类路径：编程能力强化训练 / Part B
- 难度分：Unknown
- 外部题解来源：https://leetcode.cn/problems/lru-cache/solutions/2456294/tu-jie-yi-zhang-tu-miao-dong-lrupythonja-czgt/
...
- 题解标题：[【图解】一张图秒懂 LRU！（Python/Java/C++/Go/JS/Rust）](https://leetcode.cn/problems/lru-cache/solutions/2456294/tu-jie-yi-zhang-tu-miao-dong-lrupythonja-czgt/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`tu-jie-yi-zhang-tu-miao-dong-lrupythonja-czgt`
- topic id：`2456294`
...
本题来自 `编程能力强化训练 / Part B`。先把题目抽象为该分类下的标准模型：确定要维护的对象、合法状态和答案更新时机，再用来源题解正文校准细节。
...
回到来源分类 `编程能力强化训练 / Part B`，选择同小节后续题目训练。若新题只是维护量变化，优先复用当前框架；若合法性条件变化，再调整枚举顺序、收缩策略或状态转移。
