...
- LeetCode 链接：https://leetcode.cn/problems/maximize-active-section-with-trade-ii/
- 题目 slug：`maximize-active-section-with-trade-ii`
- 来源专题：常用数据结构
- 来源分类路径：八、树状数组和线段树 / §8.3 线段树（无区间更新）
- 难度分：2941
- 外部题解来源：https://leetcode.cn/problems/maximize-active-section-with-trade-ii/solutions/3633400/qu-jian-zui-da-zhi-er-fen-cha-zhao-fen-l-n832/
...
- 题解标题：[区间最大值 + 分类讨论（Python/Java/C++/Go）](https://leetcode.cn/problems/maximize-active-section-with-trade-ii/solutions/3633400/qu-jian-zui-da-zhi-er-fen-cha-zhao-fen-l-n832/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`qu-jian-zui-da-zhi-er-fen-cha-zhao-fen-l-n832`
- topic id：`3633400`
