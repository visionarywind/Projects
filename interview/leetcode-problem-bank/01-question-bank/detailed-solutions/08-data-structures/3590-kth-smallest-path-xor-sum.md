...
- LeetCode 链接：https://leetcode.cn/problems/kth-smallest-path-xor-sum/
- 题目 slug：`kth-smallest-path-xor-sum`
- 来源专题：常用数据结构
- 来源分类路径：八、树状数组和线段树 / §8.1 树状数组
- 难度分：Unknown
- 外部题解来源：https://leetcode.cn/problems/kth-smallest-path-xor-sum/solutions/3705587/chi-xian-qi-fa-shi-he-bing-you-xu-ji-he-pm0km/
...
- 题解标题：[三种方法：启发式合并 + 有序集合 / DFS 时间戳 + 莫队 + 树状数组 / 分块](https://leetcode.cn/problems/kth-smallest-path-xor-sum/solutions/3705587/chi-xian-qi-fa-shi-he-bing-you-xu-ji-he-pm0km/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`chi-xian-qi-fa-shi-he-bing-you-xu-ji-he-pm0km`
- topic id：`3705587`
