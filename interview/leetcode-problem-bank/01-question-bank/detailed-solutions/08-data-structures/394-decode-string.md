...
- 题目 slug：`decode-string`
- 来源专题：常用数据结构
- 来源分类路径：三、栈 / §3.5 表达式解析
- 难度分：Unknown
- 外部题解来源：https://leetcode.cn/problems/decode-string/solutions/3744428/di-gui-yong-zhan-mo-ni-di-gui-pythonjava-kcsv/
...
- 题解标题：[递归 / 用栈模拟递归（Python/Java/C++/Go/JS/Rust）](https://leetcode.cn/problems/decode-string/solutions/3744428/di-gui-yong-zhan-mo-ni-di-gui-pythonjava-kcsv/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`di-gui-yong-zhan-mo-ni-di-gui-pythonjava-kcsv`
- topic id：`3744428`
