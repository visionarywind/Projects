...
- LeetCode 链接：https://leetcode.cn/problems/apply-operations-to-maximize-frequency-score/
- 题目 slug：`apply-operations-to-maximize-frequency-score`
- 来源专题：常用数据结构
- 来源分类路径：一、前缀和 / §1.3 距离和
- 难度分：2444
- 外部题解来源：https://leetcode.cn/problems/apply-operations-to-maximize-frequency-score/solutions/2569301/hua-dong-chuang-kou-zhong-wei-shu-tan-xi-nuvr/
...
- 题解标题：[两种方法：滑动窗口+中位数贪心+前缀和/贡献法（Python/Java/C++/Go）](https://leetcode.cn/problems/apply-operations-to-maximize-frequency-score/solutions/2569301/hua-dong-chuang-kou-zhong-wei-shu-tan-xi-nuvr/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`hua-dong-chuang-kou-zhong-wei-shu-tan-xi-nuvr`
- topic id：`2569301`
...
- 如果 $x$ 移入前的窗口长度是奇数，那么窗口正中间的中位数 $\textit{mid}$ 会在 $x$ 移入后，变成左半边的数字。原来的贡献是 $0$，现在的贡献是 $-\textit{mid}$，那么贡献的变化量就是 $-\textit{mid}$。再算上 $x$ 的贡献，操作次数的变化量是 $x-\textit{mid}$。
