...
- LeetCode 链接：https://leetcode.cn/problems/partition-array-for-maximum-xor-and-and/
- 题目 slug：`partition-array-for-maximum-xor-and-and`
- 来源专题：位运算
- 来源分类路径：七、线性基
- 难度分：2744
- 外部题解来源：https://leetcode.cn/problems/partition-array-for-maximum-xor-and-and/solutions/3734850/shi-zi-bian-xing-xian-xing-ji-pythonjava-3e80/
...
- 题解标题：[式子变形 + 线性基 + 最优性剪枝（Python/Java/C++/Go）](https://leetcode.cn/problems/partition-array-for-maximum-xor-and-and/solutions/3734850/shi-zi-bian-xing-xian-xing-ji-pythonjava-3e80/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`shi-zi-bian-xing-xian-xing-ji-pythonjava-3e80`
- topic id：`3734850`
...
本题来自 `七、线性基`。先把题目抽象为该分类下的标准模型：确定要维护的对象、合法状态和答案更新时机，再用来源题解正文校准细节。
...
回到来源分类 `七、线性基`，选择同小节后续题目训练。若新题只是维护量变化，优先复用当前框架；若合法性条件变化，再调整枚举顺序、收缩策略或状态转移。
