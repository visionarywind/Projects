...
- LeetCode 链接：https://leetcode.cn/problems/network-recovery-pathways/
- 题目 slug：`network-recovery-pathways`
- 来源专题：图论算法
- 来源分类路径：二、拓扑排序 / §2.2 在拓扑序上 DP
- 难度分：Unknown
- 外部题解来源：https://leetcode.cn/problems/network-recovery-pathways/solutions/3728371/er-fen-da-an-dag-dppythonjavacgo-by-endl-anax/
...
- 题解标题：[二分答案 + DAG DP / 拓扑排序（Python/Java/C++/Go）](https://leetcode.cn/problems/network-recovery-pathways/solutions/3728371/er-fen-da-an-dag-dppythonjavacgo-by-endl-anax/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`er-fen-da-an-dag-dppythonjavacgo-by-endl-anax`
- topic id：`3728371`
...
本题来自 `二、拓扑排序 / §2.2 在拓扑序上 DP`。先把题目抽象为该分类下的标准模型：确定要维护的对象、合法状态和答案更新时机，再用来源题解正文校准细节。
...
回到来源分类 `二、拓扑排序 / §2.2 在拓扑序上 DP`，选择同小节后续题目训练。若新题只是维护量变化，优先复用当前框架；若合法性条件变化，再调整枚举顺序、收缩策略或状态转移。
