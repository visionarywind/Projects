...
- LeetCode 链接：https://leetcode.cn/problems/maximize-spanning-tree-stability-with-upgrades/
- 题目 slug：`maximize-spanning-tree-stability-with-upgrades`
- 来源专题：图论算法
- 来源分类路径：四、最小生成树
- 难度分：2301
- 外部题解来源：https://leetcode.cn/problems/maximize-spanning-tree-stability-with-upgrades/solutions/3711009/liang-chong-fang-fa-er-fen-da-an-kruskal-6p7a/
...
- 题解标题：[两种方法：二分答案 / Kruskal 算法（Python/Java/C++/Go）](https://leetcode.cn/problems/maximize-spanning-tree-stability-with-upgrades/solutions/3711009/liang-chong-fang-fa-er-fen-da-an-kruskal-6p7a/)
- 作者：灵茶山艾府 (`endlesscheng`)
- 题解 slug：`liang-chong-fang-fa-er-fen-da-an-kruskal-6p7a`
- topic id：`3711009`
...
本题来自 `四、最小生成树`。先把题目抽象为该分类下的标准模型：确定要维护的对象、合法状态和答案更新时机，再用来源题解正文校准细节。
...
回到来源分类 `四、最小生成树`，选择同小节后续题目训练。若新题只是维护量变化，优先复用当前框架；若合法性条件变化，再调整枚举顺序、收缩策略或状态转移。
