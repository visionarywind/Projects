...
|---|---|---|---|---|---|---|---|---|---|---|
| Python remote task API | 已到 `submit_task` | 已追踪 | client/generator/placement 已覆盖 | get 错误已覆盖 | worker/core 清理待 M02 | ObjectRef 代表路径已覆盖 | Driver/worker 已区分 | 已有 | D01 1-13 | 部分完成：C++/Java 与 Actor 全链待补 |
