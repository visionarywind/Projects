...
- 适用范围：Megatron-LM `main` at `8190837c2b6ce176a431bc2a6ffd3439507648a7`。
...
源码版本通过 Git 确认：分支 `main`，HEAD `8190837c2b6ce176a431bc2a6ffd3439507648a7`；工作树有本知识库文档改动。README 显示发布版本 `0.19.0`，但当前 `git describe` 为 `core_v0.15.0rc7-2490-g8190837c2-dirty`，两者是不同的发布/源码标识，不能互相替代。
