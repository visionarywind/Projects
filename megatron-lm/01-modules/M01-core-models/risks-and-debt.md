# M01 Core 模型：Risks And Debt

- 文档目的：补齐 M01 核心模型的 Risks And Debt 入口。
...
|---|---|---|---|---|---|---|---|---|---|---|
| M01 Risks And Debt | 已完成 | 部分完成 | 部分完成 | 部分完成 | 部分完成 | 部分完成 | 部分完成 | 部分完成 | D01 静态 | 部分完成：需继续逐行追 backend/TE 分支 |
