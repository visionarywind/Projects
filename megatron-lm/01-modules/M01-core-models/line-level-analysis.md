# M01 Core 模型：Line Level Analysis

- 文档目的：补齐 M01 核心模型的 Line Level Analysis 入口。
...
|---|---|---|---|---|---|---|---|---|---|---|
| M01 Line Level Analysis | 已完成 | 部分完成 | 部分完成 | 部分完成 | 部分完成 | 部分完成 | 部分完成 | 部分完成 | D01 静态 | 部分完成：需继续逐行追 backend/TE 分支 |
