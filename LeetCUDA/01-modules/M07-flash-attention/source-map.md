...
- 文档目的：解释 01-modules/M07-flash-attention/source-map.md 的职责、证据和维护边界。
...
本页聚焦 01-modules/M07-flash-attention/source-map.md；具体事实以正文引用的目标源码版本为准，未执行的构建、运行和硬件行为保持未验证。
...
| launcher/dispatch | grid、D、stage、整 tile assert | `[kernels/flash-attn/mma/basic/flash_attn_mma_tiling_qkv.cu:799-945]` | 已完成代表 |
