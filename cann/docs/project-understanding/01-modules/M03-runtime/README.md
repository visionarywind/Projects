...
- `src/acl/aclrt.cpp`：ACL Runtime 导出映射和 Hook `[runtime/src/acl/aclrt.cpp:17-104]`。
...
`scheduler`、`mmpa`、DFX、platform、runtime、ACL runtime、TDT 和 tprt 由 `src/CMakeLists.txt` 组织 `[runtime/src/CMakeLists.txt:13-49]`。
